...
const usarUbicacion = () => {
    ...
    const detenerSeguimiento = () => {
        console.log("Deteniendo seguimiento de ubicación para el pedido:", pedidoActivoRef.current);
    ...
    const enviarUbicacion = async (pedidoId) => {
        try {
            ...
            console.log(`Enviando ubicación: ${ubicacion.latitud}, ${ubicacion.longitud}`);
